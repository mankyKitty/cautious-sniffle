...
data WindowAPI route = WindowAPI
  { -- | Set the current window to take up the full screen. Returns the 'WDRect' of the size of the resulting window. [spec](https://w3c.github.io/webdriver/#fullscreen-window)
    fullscreenWindow        :: route :- "fullscreen" :> HollowBody '[WaargJSON WDJson] :> Post '[WaargJSON WDJson] (Success WDRect)
  ...
  , maximizeWindow          :: route :- "maximize" :> HollowBody '[WaargJSON WDJson] :> Post '[WaargJSON WDJson] (Success WDRect)
    -- | Minimise the current window. [spec](https://w3c.github.io/webdriver/#minimize-window)
  , minimizeWindow          :: route :- "minimize" :> HollowBody '[WaargJSON WDJson] :> Post '[WaargJSON WDJson] (Success WDRect)
    -- | Create a new window. [spec](https://w3c.github.io/webdriver/#new-window)
  , createWindow            :: route :- "new" :> ReqBody '[WaargJSON WDJson] NewWindow :> Post '[WaargJSON WDJson] (Success NewWindow)
...
data SessionAPI route = SessionAPI
  ...
  , back                    :: route :- "back" :> HollowBody '[WaargJSON WDJson] :> Post '[WaargJSON WDJson] (Success ())
  ...
  , forward                 :: route :- "forward" :> HollowBody '[WaargJSON WDJson] :> Post '[WaargJSON WDJson] (Success ())
    -- | Switch to the parent of the current frame. [spec](https://w3c.github.io/webdriver/#switch-to-parent-frame)
  , switchToParentFrame     :: route :- "frame" :> "parent" :> HollowBody '[WaargJSON WDJson] :> Post '[WaargJSON WDJson] (Success ())
