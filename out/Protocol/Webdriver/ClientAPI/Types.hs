...
newtype NewSession = NewSession {
    _newSessionCapabilities :: Json
  }
...
data SetWindowRect = SetWindowRect {
    _setWindowRectX :: Json
  , _setWindowRectY :: Json
  , _setWindowRectWidth :: Json
  , _setWindowRectHeight :: Json
  }
  deriving (Show, Eq, GHC.Generic)
...
data FindElement = FindElement {
    _findElementUsing :: Text
...
data FindElementFromElement = FindElementFromElement {
    _findElementFromElementUsing :: Text
...
data FindElementsFromElement = FindElementsFromElement {
    _findElementsFromElementUsing :: Text
...
data ElementSendKeys = ElementSendKeys {
    _elementSendKeysText :: Text
...
data FindElements = FindElements {
    _findElementsUsing :: Text
...
newtype PerformActions = PerformActions {
    _performActionsActions :: (Vector Json)
  }
  deriving (Show, Eq, GHC.Generic)
